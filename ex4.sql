...
-- Et on le trie par par ordre de l'id de la table languages donc languages.id
HAVING number_frameworks > 3;
-- la "colonne" 'number_frameworks' étant fictive, on doit utiliserHAVING pour filtrer les données
